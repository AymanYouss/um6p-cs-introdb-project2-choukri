...
<body>
	<div class="main">
		<input type="checkbox" id="chk" aria-hidden="true">
			<img src="../../assets/img/OCP-transaprent.png" alt="Transparent Image" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 650px; height: auto; z-index: -1;">
			<div class="signup">
