          ...
          <div class="col-lg-6">
            <div class="hero-content">
              ...
              <div class="hero-btns">
								...
								<a href="#feature" class="main-btn border-btn btn-hover wow fadeInUp" data-wow-delay=".6s">Edit logistic</a>
							</div>
            </div>
					</div>
					<div class="col-lg-6">
				...
				<div class="row justify-content-center">
					<div class="col-xxl-5 col-xl-6 col-lg-7">
						<div class="section-title text-center mb-30">
							...
							<p class="wow fadeInUp" data-wow-delay=".4s">You can either add & edit rows, and take a look at the logistics table</p>
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-md-8 col-sm-10">
						<div class="single-feature">
							...
							<div class="content">
								<h3>Add a row</h3>
								<p>You can conveniently fill in all the relevant information to enrich the logistics table with valuable data !</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-8 col-sm-10">
						<div class="single-feature">
							...
							<div class="content">
								<h3>Edit a row</h3>
								<p>You can update the logistics table with new information, enabling you to refine any existing row !</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-8 col-sm-10">
